...
1 - Randomly initialize the parameters of the two models as well as &pi the parameter of the latent variable. Randomly initialize the 2xn vector &Gamma that will hold the conditional probabilities for the individual datapoints. 
2 - 
